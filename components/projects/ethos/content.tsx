		...
		>
			<div className="relative rounded-xl overflow-hidden max-w-6xl flex justify-center mx-auto">
				<ImageCarousel
					...
					dotsClassName="absolute bottom-4 left-1/2 -translate-x-1/2 z-10 flex items-center gap-4 sm:flex hidden"
					overlayClassName=""
					backgroundClassName=""
				/>
			</div>
